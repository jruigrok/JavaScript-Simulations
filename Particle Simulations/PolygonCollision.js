...
function draw() {
  ...
  function regularPolygon(xVel,yVel,x,y,r,c,n,dirz,colType,m){
    ...
    polygons.push(new polygon(c,xVel,yVel,X,Y,m,colType));
  }
  ...
  regularPolygon(0,0,gameArea.width/2,gameArea.height/2,50,'rgb(255,0,0)',4,0,'static',0);
  for(var i = 0; i < 10; i++){
   regularPolygon(getRndInteger(-300,300)/100,getRndInteger(-300,300)/100,gameArea.width/2,gameArea.height/2,getRndInteger(20,50),'rgb(255,0,0)',getRndInteger(3,10),getRndInteger(0,Math.PI*200)/100,'bounce',1);
  }
